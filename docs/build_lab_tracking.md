...
|---|---|---|
| Unit tests | `python -m pytest` | 195 tests passed after PR 88 |
| Full offline oracle task pass | `python3 -m aeread_lab.cli --task all --agent offline:oracle --no-cache` | all 67 task runners executed; oracle errors/regrets zero or expected near-zero; regime-relationship n=16 with mean absolute error 0, law violation 0, and fit-fail 0; regime-holdout n=32 with mean absolute error 0, law violation 0, and fit-fail 0; regime-law-audit n=40 with accuracy 1.00, invalid-accept 0, and valid-reject 0; procurement-counterfactual n=6 with accuracy 1.00, paraphrase inconsistency 0, flip miss 0, and sticky flip 0; procurement_bundle n=4 with score regret 0, accuracy 1.00, invalid 0, category miss 0, budget violation 0, and compatibility miss 0; procurement_bundle_natural n=4 with score regret 0, accuracy 1.00, invalid 0, category miss 0, budget violation 0, and compatibility miss 0; procurement_bundle_evidence n=4 with score regret 0, accuracy 1.00, invalid 0, category miss 0, budget violation 0, and compatibility miss 0; procurement_bundle_noisy_evidence n=4 with score regret 0, accuracy 1.00, invalid 0, category miss 0, budget violation 0, and compatibility miss 0; procurement_bundle_history n=4 with score regret 0, accuracy 1.00, invalid 0, category miss 0, budget violation 0, and compatibility miss 0; procurement_bundle_reserve n=4 with score regret 0, accuracy 1.00, invalid 0, category miss 0, budget violation 0, and compatibility miss 0; procurement-vendor-update n=4 with score regret 0, accuracy 1.00, parse 1.00, reputation miss 0, and myopic miss 0; pricing-counterfactual n=8 with price error 0.0024, shift miss 0, and sticky price 0; pricing-cross-elasticity n=6 with price error 0.0016, revenue gap 0, and cross-blind miss 0; pricing-multi-product n=6 with two-price L1 error 0.0034, revenue gap 0, and independent miss 0; pricing-multi-product-natural n=6 with two-price L1 error 0.0034, revenue gap 0, and independent miss 0; pricing-multi-product-capacity n=4 with two-price L1 error 0, revenue gap 0, capacity-blind miss 0, and independent miss 0; pricing-inventory-markdown n=4 with early/late price L1 error 0, revenue gap 0, and myopic miss 0; pricing-inventory-markdown-noisy n=4 with early/late price L1 error 0, revenue gap 0, and myopic miss 0; pricing-law-audit n=10 with accuracy 1.00, invalid-accept 0, and valid-reject 0; pricing-evidence-law-audit n=8 with accuracy 1.00, invalid-accept 0, and valid-reject 0; pricing-evidence-law-holdout n=24 with accuracy 1.00, invalid-accept 0, and valid-reject 0; belief-bargaining-interaction n=4 with expected-surplus gap 0, first-price error 0, second-price error 0, prior miss 0, single-cue miss 0, and single-offer miss 0; market-policy-shift n=4 with profit regret 0, static Nash miss 0, and last-price miss 0; market-policy-inventory n=4 with constrained terminal-cash regret 0, reserve violation 0, static Nash miss 0, last-price miss 0, and inventory-blind miss 0; market_trace_inventory n=4 with constrained terminal-cash regret 0, reserve violation 0, static miss 0, last-price miss 0, trace-blind miss 0, and inventory-blind miss 0; market_trace_markdown n=4 with constrained terminal-cash regret near 0, reserve violation 0, static miss 0, one-price miss 0, trace-blind miss 0, and inventory-blind miss 0; market_trace_replenishment n=4 with constrained terminal-cash regret near 0, reserve violation 0, no-replenishment miss 0, one-price miss 0, trace-blind miss 0, and replenishment-blind miss 0; mechanism-repeated n=4 with score regret 0, revenue miss 0, one-period miss 0, and risk-blind miss 0; mechanism-repeated-natural n=4 with score regret 0, revenue miss 0, one-period miss 0, and risk-blind miss 0; mechanism-participant-response n=4 with score regret 0, revenue miss 0, one-period miss 0, and response-blind miss 0; mechanism-elasticity-inference n=4 with score regret 0, revenue miss 0, one-period miss 0, and response-blind miss 0; mechanism-strategic-response n=4 with score regret 0, revenue miss 0, one-period miss 0, and response-blind miss 0; mechanism-strategic-equilibrium n=4 with score regret 0, revenue miss 0, one-period miss 0, and response-blind miss 0; mechanism-interaction-trace n=4 with score regret 0, revenue miss 0, one-period miss 0, and trace-blind miss 0; mechanism-trace-equilibrium n=4 with score regret 0, revenue miss 0, trace-projection miss 0, equilibrium-blind miss 0, and trace-blind miss 0; forecast-aggregate n=5 with expected Brier regret 0, raw-score miss 0, and shrinkage miss 0; forecast-curve n=3 with expected Brier regret 0, raw-score miss 0, and nearest-bin miss 0; forecast_curve_implicit n=3 with expected Brier regret 0, raw-score miss 0, and nearest-bin miss 0; forecast_curve_noisy n=4 with expected Brier regret 0, raw-score miss 0, and nearest-bin miss 0; forecast_curve_natural n=4 with expected Brier regret 0, raw-score miss 0, and nearest-bin miss 0; forecast_shift_calibration n=4 with expected Brier regret 0, raw-score miss 0, source-curve miss 0, and nearest-bridge miss 0; bargaining n=6 with grade error 0; belief-bargaining n=9 with surplus gap 0, strategic base gap 0, and scaffold gap 0; market n=5 with price gap 0 and survival gap 0; mechanism n=6 with score regret 0; strategic-drift n=55 with drift 0 and stress drift 0; forecast-calibration n=9 with expected Brier regret 0, posterior L1 0, and reliability miss 0; experiment-design n=5 with EV gap 0 and multi-step miss 0; retail n=5 with order error 0 and multi-period miss 0; supplier-scam n=11 with constrained regret 0, timing violation 0, and reputation miss 0; supplier-scam-natural n=11 with constrained regret 0, timing violation 0, and reputation miss 0; scam control `instrument_fires=True`; alignment-tax regret 0; revealed-allocation regret 0 |
