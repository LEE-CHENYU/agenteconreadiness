...
resulting choices via the revealed-preference axioms in `aeread_lab.core.axioms`:
...
1. **Real axiom algorithms** (`core/axioms.py`): a true GARP transitive-closure cycle
