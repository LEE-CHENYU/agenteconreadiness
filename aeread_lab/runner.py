...
from aeread_lab.tasks import (
    ...
    principal_holding_filing_trace as principal_holding_filing_trace_task,
    ...
    identification as identification_task,
    means_legitimacy as means_legitimacy_task,
...
_CASE_TASKS = {
    ...
    "principal_holding_prediction_noisy": (
        noisy_principal_holding_task.run_noisy_principal_holding_prediction_game,
        noisy_principal_holding_task.DEFAULT_CASES,
    ),
    "principal_holding_prediction_notes": (
    ...
    "principal_holding_filing_artifact": (
        principal_holding_filing_trace_task.run_principal_holding_filing_artifact_game,
    ...
    "principal_holding_filing_artifact_implicit": (
        principal_holding_filing_trace_task.run_principal_holding_filing_artifact_implicit_game,
        principal_holding_filing_trace_task.ARTIFACT_STRESS_CASES,
    ),
    "principal_holding_filing_artifact_implicit_stable": (
        principal_holding_filing_trace_task.run_principal_holding_filing_artifact_implicit_stable_game,
        principal_holding_filing_trace_task.ARTIFACT_IMPLICIT_STABLE_CASES,
    ),
    "principal_holding_filing_artifact_metadata": (
        principal_holding_filing_trace_task.run_principal_holding_filing_artifact_metadata_game,
        principal_holding_filing_trace_task.ARTIFACT_STRESS_CASES,
    ),
    "principal_holding_filing_artifact_metadata_noisy": (
        principal_holding_filing_trace_task.run_principal_holding_filing_artifact_metadata_noisy_game,
        principal_holding_filing_trace_task.ARTIFACT_METADATA_NOISY_CASES,
    ),
    "principal_holding_filing_artifact_metadata_partial": (
    ...
    "principal_holding_filing_artifact_metadata_unmarked_conflict": (
        principal_holding_filing_trace_task.run_principal_holding_filing_artifact_metadata_unmarked_conflict_game,
        principal_holding_filing_trace_task.ARTIFACT_METADATA_UNMARKED_CONFLICT_CASES,
    ),
    "principal_holding_filing_artifact_metadata_history_conflict": (
        principal_holding_filing_trace_task.run_principal_holding_filing_artifact_metadata_history_conflict_game,
        principal_holding_filing_trace_task.ARTIFACT_METADATA_HISTORY_CONFLICT_CASES,
    ),
    "principal_holding_filing_artifact_metadata_validation_process": (
        principal_holding_filing_trace_task.run_principal_holding_filing_artifact_metadata_validation_process_game,
        principal_holding_filing_trace_task.ARTIFACT_METADATA_VALIDATION_PROCESS_CASES,
    ),
    "principal_holding_filing_artifact_metadata_source_provenance": (
        principal_holding_filing_trace_task.run_principal_holding_filing_artifact_metadata_source_provenance_game,
        principal_holding_filing_trace_task.ARTIFACT_METADATA_SOURCE_PROVENANCE_CASES,
    ),
    "principal_holding_filing_artifact_metadata_source_context": (
        principal_holding_filing_trace_task.run_principal_holding_filing_artifact_metadata_source_context_game,
        principal_holding_filing_trace_task.ARTIFACT_METADATA_SOURCE_CONTEXT_CASES,
    ),
    "principal_holding_filing_artifact_metadata_source_status_ablation": (
        principal_holding_filing_trace_task.run_principal_holding_filing_artifact_metadata_source_status_ablation_game,
        principal_holding_filing_trace_task.ARTIFACT_METADATA_SOURCE_STATUS_ABLATION_CASES,
    ),
    "principal_holding_filing_artifact_metadata_source_status_neutral": (
        principal_holding_filing_trace_task.run_principal_holding_filing_artifact_metadata_source_status_neutral_game,
        principal_holding_filing_trace_task.ARTIFACT_METADATA_SOURCE_STATUS_NEUTRAL_CASES,
    ),
    "principal_holding_filing_artifact_metadata_source_status_neutral_intro": (
        principal_holding_filing_trace_task.run_principal_holding_filing_artifact_metadata_source_status_neutral_intro_game,
        principal_holding_filing_trace_task.ARTIFACT_METADATA_SOURCE_STATUS_NEUTRAL_INTRO_CASES,
    ),
    "principal_holding_filing_artifact_metadata_source_audit": (
    ...
    "market_trace_markdown": (
        market_task.run_market_trace_markdown_game,
        market_task.TRACE_INVENTORY_CASES,
    ),
    "market_trace_replenishment": (
        market_task.run_market_trace_replenishment_game,
    ...
    "mechanism_trace_equilibrium": (
        mechanism_task.run_mechanism_trace_equilibrium_game,
    ...
    "forecast_shift_calibration": (
        forecast_calibration_task.run_forecast_shift_calibration_game,
        forecast_calibration_task.SHIFT_CALIBRATION_CASES,
    ),
    "forecast_rolling_calibration": (
    ...
    "forecast_rolling_log_noisy": (
        forecast_calibration_task.run_forecast_rolling_log_noisy_game,
        forecast_calibration_task.NOISY_ROLLING_LOG_CALIBRATION_CASES,
    ),
    "forecast_event_log_calibration": (
    ...
    "procurement_vendor_update_noisy": (
        procurement_task.run_procurement_vendor_update_noisy_game,
        procurement_task.PROCUREMENT_VENDOR_UPDATE_NOISY_CASES,
    ),
...
def run_task(
    ...
    if task == "identification":
        # Methodology-validation battery on synthetic data with a known planted
        # utility; the agent argument is ignored (the instrument validates itself).
        return identification_task.run_identification_battery()
    if task == "means_legitimacy":
        cases = means_legitimacy_task.default_cases()
        if limit is not None:
            cases = cases[:limit]
        return means_legitimacy_task.run_means_legitimacy_battery(agent, cases=cases)
    if task == "regime":
