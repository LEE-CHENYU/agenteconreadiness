...
- Six open methodological questions with stated working positions + "Open:" invitations — overfitting + function misspecification (Q1), quantitative-feature scoring discipline (Q2), RL training-signal design (Q3), Layer 1+2 vs Layer 3 residual hypothesis (Q4), OpenSpiel-compatible environment substrate (Q5), operational emergence definition (Q6) — [`docs/methodology.md` § Critical methodological questions](docs/methodology.md#critical-methodological-questions-open-qa)
